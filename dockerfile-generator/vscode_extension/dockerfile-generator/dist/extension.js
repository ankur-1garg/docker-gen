...
function activate(context) {
    ...
    let disposable = vscode.commands.registerCommand("mcp-dockerfile-generator.generate", async () => {
        const serverUrl = (0, configuration_1.getServerUrl)();
        ...
        try {
            ...
            await vscode.window.withProgress({
                ...
                const dockerfileContent = await (0, apiService_1.generateDockerfileFromServer)(payload);
            ...
            vscode.window.showErrorMessage(`Failed to generate Dockerfile: ${errorMessage}`);
        }
    });
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.generateDockerfileFromServer = generateDockerfileFromServer;
// vscode_extension/src/services/apiService.ts
const axios_1 = __importDefault(__webpack_require__(4));
const configuration_1 = __webpack_require__(2); // Import config helper
// Type guard to check for our specific error structure
function isDockerfileResponseError(obj) {
 ...
 */
async function generateDockerfileFromServer(payload) {
    const serverUrl = (0, configuration_1.getServerUrl)();
    ...
    try {
        ...
        if (response.status === 200 &&
            ...
            throw new Error(`Received an unexpected response format from the server (Status: ${response.status}).`);
        }
    }
    catch (error) {
        ...
        if (axios_1.default.isAxiosError(error)) {
            ...
            if (axiosError.response) {
                ...
                if (isDockerfileResponseError(responseData)) {
                    console.error(`Server error ${axiosError.response.status}: ${responseData.message} (Code: ${responseData.error_code})`);
                    // Throw a more specific error message for the user
                    throw new Error(`Server Error (${axiosError.response.status}): ${responseData.message}`);
                }
                else {
                    // Fallback if error response doesn't match expected structure
                    console.error(`Server error ${axiosError.response.status}:`, responseData);
                    throw new Error(`Server returned an error (Status ${axiosError.response.status}). Check server logs for details.`);
                }
            }
                ...
                throw new Error(`Could not connect to the MCP server at ${serverUrl}. Please check if it's running and accessible.`);
            }
            else {
...
var CombinedStream = __webpack_require__(6);
...
var populate = __webpack_require__(64);
...
var util = __webpack_require__(7);
var Stream = (__webpack_require__(8).Stream);
var DelayedStream = __webpack_require__(9);
...
var GetIntrinsic = __webpack_require__(29);
...
var $EvalError = __webpack_require__(32);
var $RangeError = __webpack_require__(33);
var $ReferenceError = __webpack_require__(34);
var $SyntaxError = __webpack_require__(35);
var $TypeError = __webpack_require__(36);
var $URIError = __webpack_require__(37);

var abs = __webpack_require__(38);
var floor = __webpack_require__(39);
var max = __webpack_require__(40);
var min = __webpack_require__(41);
var pow = __webpack_require__(42);
var round = __webpack_require__(43);
...
var $ObjectGPO = __webpack_require__(53);
var $ReflectGPO = __webpack_require__(52);
...
var reflectGetProto = __webpack_require__(52);
var originalGetProto = __webpack_require__(53);

var getDunderProto = __webpack_require__(54);
...
var $call = __webpack_require__(58);
var $actualApply = __webpack_require__(59);
...
var $apply = __webpack_require__(60);
var $call = __webpack_require__(58);
var $reflectApply = __webpack_require__(61);
